...
public class ProfesionControllerV1 {
	...
	public ProfesionResponse obtenerProfesionPorId(@PathVariable String database, @PathVariable Integer id) {
		log.info("Into obtenerProfesionPorId REST API");
		return profesionInputAdapterRest.obtenerProfesionPorId(database.toUpperCase(), id);
	}
